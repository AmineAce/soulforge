...
|-------|------------------|-------------|
| `proxy` | [CLIProxyAPI](https://github.com/luispater/CLIProxyAPI) — local LLM relay that lets you route Claude, GPT, Gemini, and Grok through your existing chat subscriptions instead of API keys. | ~25 MB |
