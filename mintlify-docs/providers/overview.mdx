...
| **Proxy** | Local CLIProxyAPI relay — routes Claude, GPT, Gemini, Grok via your existing chat subscriptions. Install the addon (`soulforge addon install proxy`), then `/proxy login`. See [addons](/tools/addons). |
